...
| etip_admin | ✅ Deployed | 0.4.0 | 2026-03-26 | Port 3022. 35 endpoints, 190 tests. Queue monitor + DLQ processor + P2-1 queue alerting. **Session 78:** GET /feed-usage/summary (tenant feed usage aggregation). |
