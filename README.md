...
![Tests](https://img.shields.io/badge/tests-2165%20passing-00ff88)
...
| **Phase 4 started + Phase 3 + Differentiators A/A+/B** | **Phase 4 in progress** (threat graph feature-complete, correlation next) | **2165** |
