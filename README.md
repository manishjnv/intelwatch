...
![Tests](https://img.shields.io/badge/tests-5192%2B%20passing-00ff88)
...
| Frontend (React 18 + Vite, 19 data pages, 20 viz components, demo fallbacks all 5 entity types + reporting + alerting + analytics, D3 code-split) | ✅ Live on VPS | 688 |
