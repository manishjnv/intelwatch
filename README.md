...
![Tests](https://img.shields.io/badge/tests-5837%2B%20passing-00ff88)
...
| Frontend (React 18 + Vite, 20 data pages, 21 viz components, demo fallbacks all 5 entity types + reporting + alerting + analytics, D3 code-split, mobile responsive, detail panels on all entity pages) | ✅ Live on VPS | 755 |
