...
const ConfigSchema = z.object({
  ...
  TI_ONBOARDING_PORT: z.coerce.number().int().min(1).max(65535).default(3018),
  TI_ONBOARDING_HOST: z.string().default('0.0.0.0'),
...
export function loadConfig(env: Record<string, string | undefined>): OnboardingConfig {
...
export function getConfig(): OnboardingConfig {
