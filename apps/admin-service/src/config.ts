...
const ConfigSchema = z.object({
  ...
  TI_ADMIN_PORT: z.coerce.number().int().min(1).max(65535).default(3022),
  TI_ADMIN_HOST: z.string().default('0.0.0.0'),
...
export function loadConfig(env: Record<string, string | undefined>): AdminConfig {
