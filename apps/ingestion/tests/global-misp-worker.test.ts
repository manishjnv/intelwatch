...
describe('GlobalMISPWorker', () => {
  beforeEach(() => { vi.clearAllMocks(); });

  it('uses FEED_FETCH_GLOBAL_REST queue (MISP uses REST transport)', () => {
    createGlobalMISPWorker({ db: {} as never, logger: createMockLogger(), redisUrl: 'redis://localhost:6379' });
