...
const EnvSchema = z.object({
  ...
  TI_THREAT_ACTOR_INTEL_PORT: z.coerce.number().int().min(1).max(65535).default(3008),
  TI_THREAT_ACTOR_INTEL_HOST: z.string().default('0.0.0.0'),
 ...
 * @throws AppError if required vars are missing or invalid.
 */
...
/** Returns the loaded config. Throws if loadConfig() has not been called. */
