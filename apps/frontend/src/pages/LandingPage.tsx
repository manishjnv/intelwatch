 ...
 * All visual layers, title, subtitle, pill, version are FROZEN.
 */
  ...
  return (
    <>
      <style>{`
        ...
        .lp-title {
          font-size: clamp(3.2rem, 8vw, 6rem); font-weight: 800; letter-spacing: -0.02em;
        ...
        .lp-pill {
          ...
          padding: 0.6rem 2rem; border: 1px solid rgba(0,255,136,0.12); border-radius: 100px;
          color: rgba(0,255,136,0.8); font-size: 0.8rem; letter-spacing: 0.1em; text-transform: uppercase;
          font-weight: 500; backdrop-filter: blur(10px); background: rgba(0,255,136,0.02);
          box-shadow: 0 0 30px rgba(0,255,136,0.03), inset 0 0 30px rgba(0,255,136,0.02); cursor: default;
        }
        ...
        .lp-btn-primary {
          padding: 0.65rem 2rem; background: rgba(0,255,136,0.08); border: 1px solid rgba(0,255,136,0.25);
          border-radius: 100px; color: #00ff88; font-size: 0.85rem; font-weight: 500; letter-spacing: 0.06em;
        ...
        .lp-btn-secondary {
          padding: 0.65rem 2rem; background: transparent; border: 1px solid rgba(255,255,255,0.06);
          border-radius: 100px; color: rgba(255,255,255,0.3); font-size: 0.85rem; font-weight: 400;
          letter-spacing: 0.06em; cursor: pointer; transition: border-color 0.2s, color 0.2s; text-transform: uppercase;
        }
